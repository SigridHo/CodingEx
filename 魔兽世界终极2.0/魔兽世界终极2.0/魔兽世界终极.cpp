...
public:
	...
	arrow& operator = (arrow temp) 
	{
		UsedTimes = temp.UsedTimes;
		Power = temp.Power;
		return *this;
	}
};
...
public:
	...
	virtual Warrior& operator = (Warrior temp);
...
Warrior& Warrior::operator = (Warrior temp)
{
	Color = temp.Color;
	Hp = temp.Hp;
	Type = temp.Type;
...
Dragon& Dragon::operator = (Dragon temp)
{
	Color = temp.Color;
	Hp = temp.Hp;
	Type = temp.Type;
...
Lion& Lion::operator = (Lion temp)
{
	...
	Arrow = temp.Arrow;
	Bomb = temp.Bomb;
	loyalty = temp.loyalty;
	return *this;
}

Iceman& Iceman::operator = (Iceman temp)
{
	Color = temp.Color;
	Hp = temp.Hp;
	Type = temp.Type;
...
int City:: ATTACK() 
{
	...
	bool tempb = NULL;
	bool wolf = false;
	if((state[0] != NULL) && (state[1] != NULL) && (state[0]->Hp <= 0) && (state[1]->Hp <= 0)) {state[0] = NULL; state[1] = NULL; return 10;}
